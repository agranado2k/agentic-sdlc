...
for f in tests SETUP.md EXCLUSIONS.md scripts/agents.kit.sh scripts/agents.kit.config.sh scripts/guards.kit.sh scripts/guards.kit.config.sh scripts/mutation.kit.sh scripts/mutation.kit.config.json setup; do
