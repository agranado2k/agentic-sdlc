...
KIT_ONLY="tests/kit-demo.sh tests/gate-path-roots.test.sh tests/docs-demo.sh tests/lib.sh tests/self-host.test.sh tests/guards-demo.sh tests/adapters-demo.sh tests/tdd-pairing-guard.test.sh tests/tdd-pairing-guard-ci.test.sh tests/behavior-delta.test.sh tests/worktree-cleanup.test.sh tests/agents-tiers.test.sh tests/implement-deliver.test.sh tests/ai-review-template.test.sh tests/exclusions.test.sh tests/dogfood-optin.test.sh tests/setup-demo.sh tests/review-pr-output.test.sh tests/adopt-demo.sh tests/docs-gate-advisory.test.sh tests/design-brief-skill.test.sh tests/housekeeping-skill.test.sh tests/manifest.test.sh .github/workflows/kit-ci.yml .github/workflows/kit-guards.yml EXCLUSIONS.md scripts/agents.kit.config.sh scripts/agents.kit.sh SETUP.md setup/agent-bootstrap.md tests/no-box-art.test.sh tests/mutation-kit.test.sh scripts/mutation.kit.sh scripts/mutation.kit.config.json tests/fixture-builders.test.sh"
...
KIT_OWN="AGENTS.md CLAUDE.md GEMINI.md docs/diary.md docs/domain-glossary.md docs/adr/INDEX.md docs/adr/0001-the-kit-self-hosts-its-own-constitution.md docs/adr/0002-strategic-means-ousterhout.md docs/adr/0003-the-kit-maps-its-own-tiers.md docs/adr/NNNN-template.md .github/PULL_REQUEST_TEMPLATE.md docs/adr/0004-the-root-manual-is-the-kits-local-article.md"
