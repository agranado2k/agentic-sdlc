...
10. **Human-in-the-loop script.** Last resort. If a human must click, drive _them_ with `.agents/skills/diagnose/scripts/hitl-loop.template.sh` so the loop is still structured. Captured output feeds back to you.
